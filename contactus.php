...
$status=0;
$sql="INSERT INTO  tblcontactusquery(category,name,EmailId,phone,Message,status) VALUES(:category,:name,:EmailId,:phone,:Message,:status)";
...
if($lastInsertId)
{
$msg="Message Sent, Thank you for contacting us.We eill get back to you through the email as soon as possible.";
}
else 
{
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <p>
                <b>Address: </b> West Pokot
                    <br>
                </p>
                <p>
                   <b> Phone:</b> +254722178177
                </p>
                <p>
              <b>  EmailId: </b>tapachyouthemp@gmail.com
                    </a>
                </p>
            </div>
        </div>
